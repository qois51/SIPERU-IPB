    ...
    <div className="min-h-screen flex items-center justify-center p-4 py-12" 
      ...
      <div className="w-full max-w-4xl bg-[#263C92]/70 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
        ...
        <form className="space-y-8 text-white">
          <h2 className="text-3xl font-bold mb-8">Upload Surat</h2>
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <div className="absolute right-4 pointer-events-none">
                <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M19 9l-7 7-7-7"></path></svg>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <input 
              type="file" 
              className="w-full p-3 rounded-xl bg-white text-gray-800 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#263C92] file:text-white hover:file:bg-blue-700 transition"
            />
          </div>

          <div className="pt-6 flex justify-end">
            <button type="submit" className="bg-[#009B4D] text-white font-bold py-3 px-12 rounded-xl hover:bg-[#008542] transition duration-300 shadow-xl text-lg">
              Submit
            </button>
          </div>
        </form>
